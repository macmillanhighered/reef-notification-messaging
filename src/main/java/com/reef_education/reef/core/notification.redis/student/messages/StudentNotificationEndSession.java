...
/**
 * Designed to mimic the WebSockets resource "endSession".
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class StudentNotificationEndSession extends StudentNotificationBase
{
    private UUID courseId;

    public StudentNotificationEndSession()
    {
        this.action = StudentNotification.ACTION_END_CLASS_SESSION;
    }

    public StudentNotificationEndSession(UUID courseId)
    {
        this();
